...
_LENGTH_INSTRUCTION = (
    ...
    "괄호는 쓰지 마세요. 괄호 안에 있던 내용은 지우지 말고 새로운 짧은 문장으로 풀어 쓰세요.\n"
...
_REPLACEMENT_INSTRUCTION = (
    ...
    "'○○ 감면'은 '○○을 깎아 줌'처럼, '○○ 납부'는 '○○ 내기'처럼 풀어 쓰세요. "
    "바꾼 뒤에는 왼쪽 표현이 결과에 한 글자도 남아 있으면 안 됩니다.\n"
    "다만 목록에 없는 기관 이름·제도 이름·서류 이름은 정해진 이름이므로 바꾸지 말고 그대로 쓰세요. "
...
PLACEHOLDER_INSTRUCTION = (
    ...
    "자리표시자가 괄호 안 예시로 들어 있을 때가 가장 자주 실수하는 자리입니다. "
    "괄호를 없애면서 자리표시자까지 지우지 말고, 그 자리표시자를 새 문장으로 옮겨 그대로 적으세요."
)
...
_SELF_CHECK_INSTRUCTION = (
    ...
    "3. [어려운 표현 바꾸기] 목록의 왼쪽 표현을 하나씩 훑어보며 "
    "결과에 남은 것이 없는지 확인했는가? 활용형과 다른 낱말 앞에 붙어 있는 것까지 찾아야 한다.\n"
