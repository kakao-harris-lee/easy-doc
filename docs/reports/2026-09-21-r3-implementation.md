...
PR #139 첫 원격 CI에서 기본 E2E는 27 passed/1 skipped였지만 결제 집행 E22·E23은 한 단어 반복 입력이 기존 4단어 최소 규칙에 막혀 실패했다. 두 실패 화면의 입력 경고를 확인했고, 테스트 입력만 정확히 100·900·10,000자이면서 네 단어가 되도록 보정했다. 0.1·0.9·10크레딧 경계와 402·잔액·거래 단언은 유지했다. 수정 후 로컬 fake SMS/결제/LLM Compose 스택에서 집행 E2E 2/2 통과(15.9초), 프런트 check 통과를 확인했다.
