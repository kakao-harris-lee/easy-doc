...
작성일: 2026-09-24 · 상태: 구현 착수. 상위 문서: [R7 수정 계획](2026-09-24-contextual-illustration-correction.md) §2~4·§6 결정표. 이 명세는 ER-17의 경계와 판단을 고정한다. 파일 경로·SQL 이름 같은 세부는 구현 PR에서 기존 관례를 따라 정하되, 아래 규칙을 바꾸려면 이 문서를 먼저 고친다.
