...
| **⑤ 게이트 17 종결** (`17_gate16-fixes`, 대상 `1cb7bdf..48a791c`) | **진행 중** | `안 돎` | 1단계 진행 중(`reviews/17_*` 미생성). **이번 배치 5 커밋은 아직 독립 리뷰를 받지 않았다** — 이 저장소는 "고쳤다고 보고한 직후 그 수정의 결함이 잡힌" 이력이 반복돼 있다(§4 ③) |
