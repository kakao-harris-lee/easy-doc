...
| `09_masking-grammar` | `6d8e88c..c61c94e` | **1단계 진행 중** (2026-08-14). 게이트 08 차단 해소 배치(코드 조각 10커밋) — C-01①②·C-10·C-11 문법, 스캐너 4건, C-08·C-05·C-18, fixture 69케이스 동결, C-02 선언 하한. focus = 해소 검증(검증 대기 C-06·C-12구현분·재개방 4곳) + SEP 문법 경계 + fixture 견고성 + 스캐너 잔여 표면 | (1단계 산출물 대기) |
