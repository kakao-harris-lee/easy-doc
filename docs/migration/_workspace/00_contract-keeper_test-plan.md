...
| 3 | #1·#2·#3 + X-A*·X-B*·X-C*·X-D1·X-D2·X-D3·X-E1 + **X-I1·X-I2** + **X-J2**(OQ-3 기제 확정 후) | Contract, DB |
| 4 | #4~#9 + X-D4·X-D5·X-D6·X-E2~X-E4·X-F*·X-G* + **X-J1·X-J3**(OQ-2·OQ-4 조항 확정 후 — 함께 판정) | Contract, Document, Security |
