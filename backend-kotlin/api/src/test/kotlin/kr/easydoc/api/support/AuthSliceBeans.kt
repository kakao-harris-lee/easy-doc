...
class AuthSliceBeans {
    ...
    @Bean
    fun actionGuideAnalysisService(): kr.easydoc.application.actionguide.ActionGuideAnalysisService =
        org.mockito.Mockito.mock(kr.easydoc.application.actionguide.ActionGuideAnalysisService::class.java)
    ...
    @Bean
    fun reviewHistoryService(): kr.easydoc.application.document.ReviewHistoryService =
    ...
    @Bean
    fun illustrationsService(): kr.easydoc.application.illustration.IllustrationsService =
        org.mockito.Mockito.mock(kr.easydoc.application.illustration.IllustrationsService::class.java)

    @Bean
    fun illustrationPlacementService(): kr.easydoc.application.illustration.IllustrationPlacementService =
        org.mockito.Mockito.mock(kr.easydoc.application.illustration.IllustrationPlacementService::class.java)

    @Bean
    fun illustrationSuggestionJobService():
        kr.easydoc.application.illustration.suggestion.IllustrationSuggestionJobService =
        org.mockito.Mockito.mock(
            kr.easydoc.application.illustration.suggestion.IllustrationSuggestionJobService::class.java,
        )

    @Bean
    fun illustrationSuggestionResultService():
        kr.easydoc.application.illustration.suggestion.IllustrationSuggestionResultService =
        org.mockito.Mockito.mock(
            kr.easydoc.application.illustration.suggestion.IllustrationSuggestionResultService::class.java,
        )
