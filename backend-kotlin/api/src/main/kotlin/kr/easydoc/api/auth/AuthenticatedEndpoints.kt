...
object AuthenticatedEndpoints {
    ...
    val PROTECTED_PATH_PATTERNS: List<String> =
        listOf(
            ...
            "/conversions/{conversion_id}/review-support/items",
            ...
            "/conversions/{conversion_id}/action-guide-workflow",
            "/conversions/{conversion_id}/action-guide-analysis-jobs",
            "/conversions/{conversion_id}/action-guide-analyses/{analysis_id}/signals/{signal_id}",
            "/conversions/{conversion_id}/action-guide-analyses/{analysis_id}/review",
            "/conversions/{conversion_id}/action-guide-drafts",
            "/conversions/{conversion_id}/action-guide-drafts/{draft_id}/review",
            "/conversions/{conversion_id}/action-guide-drafts/{draft_id}/apply",
            "/conversions/{conversion_id}/action-guide-drafts/{draft_id}/export",
            "/conversions/{conversion_id}/action-guide-previous-bodies",
            "/conversions/{conversion_id}/action-guide-previous-bodies/{snapshot_id}",
