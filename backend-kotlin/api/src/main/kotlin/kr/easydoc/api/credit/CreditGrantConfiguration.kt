 ...
 * [TransactionRunner]·[UserRepository]·[RecordPersonalDataAccess]는 `infrastructure`의
 * `CreditAccountConfiguration`·`AuthConfiguration`·`AccessLogConfiguration`이 프로필과
 * 무관하게 이미 조립한 빈이다(`UsageReportConfiguration` KDoc과 같은 이유 — `api`는
